...
Then all configurations are confirmed working.</content>
<parameter name="filePath">openspec/changes/add-deployment-setup-guide/specs/deployment-setup/spec.md