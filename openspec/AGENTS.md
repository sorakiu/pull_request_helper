...
1. **Create feature branch** - Create and switch to a branch named `feature/[change-id]` (e.g., `feature/add-bulk-pull-request-creation`)
2. **Read proposal.md** - Understand what's being built
2. **Read design.md** (if exists) - Review technical decisions
3. **Read tasks.md** - Get implementation checklist
4. **Implement tasks sequentially** - Complete in order
5. **Commit per task** - After completing each task, commit with message "X.Y: [brief description]" on the feature branch (e.g., "1.1: Set up Django project with DRF, allauth/dj-rest-auth for GitHub OAuth")
